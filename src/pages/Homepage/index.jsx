      ...
      <div className="bg-white-A700 flex flex-col font-sourcesanspro gap-[54px] items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-start justify-start w-full">
            ...
            <div className="absolute h-[473px] inset-y-[0] my-auto right-[0] w-[94%] md:w-full">
              ...
              <div className="absolute flex flex-col items-start justify-start left-[0] rounded-[5px] top-[10%] w-[55%]">
                ...
                <div className="flex sm:flex-col flex-row gap-6 items-center justify-start mt-[39px] rounded-[5px] w-[71%] md:w-full">
                  <Button className="bg-black-900 cursor-pointer font-bold leading-[normal] min-w-[201px] py-6 rounded-[5px] text-base text-center text-white-A700">
                    Contact Us
                  </Button>
                  <Button className="border-[3px] border-black-900 border-solid cursor-pointer font-bold leading-[normal] min-w-[201px] py-[23px] rounded-[5px] text-base text-black-900 text-center">
                    About Us
                  </Button>
                </div>
              </div>
            ...
            <div className="bg-red-50 flex flex-col items-center justify-start p-28 md:px-10 sm:px-5 rounded-[90px] w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mb-1.5 w-[95%] md:w-full">
                <div className="flex flex-col gap-10 items-start justify-start w-[23%] md:w-full">
                  <Button className="bg-red-300 flex h-[46px] items-center justify-center p-[11px] rounded-[10px] shadow-bs w-[46px]">
                    <Img
                      className="h-[23px]"
                ...
                <div className="bg-white-A700 flex flex-col items-start justify-start md:ml-[0] ml-[102px] p-[25px] sm:px-5 rounded-[30px] shadow-bs1 w-[31%] md:w-full">
                  <div className="flex flex-col gap-[37px] items-start justify-start mb-2 mt-3 w-[95%] md:w-full">
                    <Button className="bg-cyan-400 flex h-[46px] items-center justify-center p-[11px] rounded-[10px] shadow-bs2 w-[46px]">
                      <Img
                        className="h-[23px]"
                ...
                <div className="flex flex-col gap-10 items-start justify-start md:ml-[0] ml-[86px] w-[27%] md:w-full">
                  <Button className="bg-lime-800 flex h-[46px] items-center justify-center p-[11px] rounded-[10px] shadow-bs3 w-[46px]">
                    <Img
                      className="h-[23px]"
          ...
          <div className="sm:h-[1269px] h-[559px] md:h-[997px] mt-[100px] md:px-5 relative w-full">
                ...
                <div className="flex flex-col md:gap-10 gap-[68px] items-center justify-start w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                    ...
                    <div className="flex md:flex-1 flex-row gap-[9px] items-center justify-between w-[13%] md:w-full">
                      <Button className="bg-red-401 flex items-center justify-center p-[11px]">
                  ...
                  <List
                    ...
                    orientation="horizontal"
                  >
                    <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-[30px] sm:px-5 rounded-[10px] shadow-bs4 w-full">
            ...
            <Button className="absolute bg-red-401 border-[9px] border-solid border-white-A700 flex h-[68px] items-center justify-center left-[9%] p-[26px] sm:px-5 rounded-[50%] top-[0] w-[68px]">
